...
/*  Notes:
	...
	INSERT INTO TableName(Comma, Separated, ListOf, ColumnNames)
	VALUES ('A', (SELECT SingleValue FROM SomeTables), 'Per', 'Column')
...
-- TODO: Student Answer Here....
-- TIP: When inserting into a datetime column, you can use a string and SQL Server will convert it for you. E.g. 'Jan 5, 2020'

INSERT INTO Student(FirstName, LastName, Gender, Birthdate)
VALUES ('Gladys', 'Phillips', 'F', 'June 7, 1956')

INSERT INTO Student(FirstName, LastName, Gender, Birthdate)
VALUES ('Suzanne', 'Harris', 'F', 'Aug 1, 1989')

INSERT INTO Student(FirstName, LastName, Gender, Birthdate)
VALUES ('Pauline', 'Perkins', 'F', 'July 7 1979')
...
-- TODO: Student Answer Here....
-- SP_HELP Student -- This will show all the details for each component of the table
